...
\usepackage[left=0.5in, right=0.5in, top=0.5in, bottom=0.25in]{geometry}
...
\resumeProjectHeading
    ...
    \resumeItemListStart
        ...
        \resumeItem{Implemented \textbf{differentiable multi-view projection with learnable pose optimization} for joint slice alignment \& geometry recovery, used Fourier positional encodings to capture high-frequency boundaries under sparse supervision.}
    ...
    \resumeItemListStart
        \resumeItem{Authoring a \textbf{comprehensive open-source computer vision course} covering Classical 2D Vision, Deep Learning for Vision, 3D Computer Vision, Vision Geometries, Image-based Localization \& Mapping, Vision Synthesis and Perception Physics}.
    \resumeItemListEnd
